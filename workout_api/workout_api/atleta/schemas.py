...
class Atleta(BaseSchema):
    ...
    peso: Annotated[
        PositiveFloat, Field(description="Peso do atleta em kilos", examples=[65.8])
    ]
    altura: Annotated[
        PositiveFloat, Field(description="Altura do atleta em metros", examples=[1.73])
    ]
    sexo: Annotated[
...
class AtletaUpdate(BaseSchema):
    nome: Annotated[
        Optional[str],
        Field(None, description="Nome do atleta", examples=["Joao"], max_length=50),
    ]
    idade: Annotated[
        Optional[int], Field(None, description="Idade do atleta", examples=[25])
    ]
