...
class Atleta(BaseSchema):
    ...
    peso: Annotated[PositiveFloat, Field(description="Peso do atleta em kilos", examples=[65.8])]
    altura: Annotated[PositiveFloat, Field(description="Altura do atleta em metros", examples=[1.73])]
